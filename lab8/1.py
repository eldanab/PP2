...
class Coin(pygame.sprite.Sprite):  
    def __init__(self):
        super().__init__()
        orig_image = pygame.image.load("coin.png") 
...
pygame.time.set_timer(CREATE_COIN, 4000)  # Generate a coin every 4 seconds
...
while True:
    ...
    coins_collected_text = font_small.render(
        "Coins Collected: " + str(COINS_COLLECTED), True, BLACK
    )
    ...
    # Check for collisions with player and coins
